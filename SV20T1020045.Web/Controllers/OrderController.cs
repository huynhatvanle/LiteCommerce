...
namespace SV20T1020045.Web.Controllers
{
    ...
    public class OrderController : Controller
    {
        ...
        [HttpGet]
        public IActionResult SaveProvinces(int id = 0)
        {
            try
            {
                ViewBag.OrderID = id;
        ...
        [HttpPost]
        public IActionResult SaveProvinces(int id = 0, string deliveryprovince = "", string deliveryaddress = "")
        {
            try
            {
                ...
                bool result = OrderDataService.ProvinceOrder(id, deliveryprovince, deliveryaddress);
