...
namespace SV20T1020045.BusinessLayers
{
    public class OrderDataService
    {
        ...
        /// <summary>
        /// Chỉnh sửa tỉnh thành/ địa chỉ giao hàng
        /// </summary>
        /// <param name="orderID"></param>
        /// <param name="deliveryProvince"></param>
        /// <param name="deliveryAddress"></param>
        /// <returns></returns>
        public static bool ProvinceOrder(int orderID, string deliveryProvince, string deliveryAddress)
        {
            Order? data = orderDB.Get(orderID);
            if (data == null)
                return false;
            if (data.Status == Constants.ORDER_INIT || data.Status == Constants.ORDER_ACCEPTED)
            {
                return orderDB.ProvinceOrder(orderID, deliveryProvince, deliveryAddress);
            }
            return false;
        }
        /// <summary>
